...
const jogos: CatalogGame[] = [
  ...
  { nome: "Mahjong Ways", provider: "PG", rota: "/jogos/mahjong-ways", capa: "🎋", subtitle: "Oriental cluster slot", accentClass: "from-sky-300/20 via-emerald-400/15 to-slate-950", glowClass: "shadow-[0_0_30px_rgba(56,189,248,0.18)]" },
  { nome: "Dragon Hatch", provider: "PG", rota: "/jogos/dragon-hatch", capa: "🐉", subtitle: "Dragon eggs & fire", badge: "Boost", accentClass: "from-orange-300/20 via-red-500/20 to-slate-950", glowClass: "shadow-[0_0_30px_rgba(249,115,22,0.2)]" },
  ...
  { nome: "Wild Bandito", provider: "PG", rota: "/jogos/wild-bandito", capa: "🎸", subtitle: "Outlaw reels", badge: "New", accentClass: "from-orange-300/20 via-amber-500/15 to-slate-950", glowClass: "shadow-[0_0_30px_rgba(251,146,60,0.18)]" },
  { nome: "Piggy Gold", provider: "PG", rota: "/jogos/piggy-gold", capa: "🐷", subtitle: "Golden vault spin", accentClass: "from-pink-300/20 via-rose-500/20 to-slate-950", glowClass: "shadow-[0_0_30px_rgba(244,114,182,0.18)]" },
  { nome: "Candy Burst", provider: "PG", rota: "/jogos/candy-burst", capa: "🍬", subtitle: "Sugar pop reels", accentClass: "from-fuchsia-300/20 via-pink-500/20 to-slate-950", glowClass: "shadow-[0_0_30px_rgba(232,121,249,0.18)]" },
  { nome: "Ganesha Gold", provider: "PG", rota: "/jogos/ganesha-gold", capa: "🐘", subtitle: "Golden elephant bonus", accentClass: "from-yellow-300/20 via-amber-500/20 to-slate-950", glowClass: "shadow-[0_0_30px_rgba(250,204,21,0.18)]" },
  { nome: "Leprechaun Riches", provider: "PG", rota: "/jogos/leprechaun-riches", capa: "☘️", subtitle: "Clover jackpot", accentClass: "from-emerald-300/20 via-lime-500/20 to-slate-950", glowClass: "shadow-[0_0_30px_rgba(74,222,128,0.18)]" },
  { nome: "Gem Saviour", provider: "PG", rota: "/jogos/gem-saviour", capa: "💎", subtitle: "Crystal rescue", accentClass: "from-cyan-300/20 via-sky-500/20 to-slate-950", glowClass: "shadow-[0_0_30px_rgba(34,211,238,0.18)]" },
  { nome: "Tree of Fortune", provider: "PG", rota: "/jogos/tree-of-fortune", capa: "🌳", subtitle: "Prosperity spins", accentClass: "from-emerald-300/20 via-green-500/20 to-slate-950", glowClass: "shadow-[0_0_30px_rgba(34,197,94,0.18)]" },
  ...
  { nome: "Starlight Princess", provider: "PP", rota: "/jogos/starlight-princess", capa: "⭐", subtitle: "Celestial reels", accentClass: "from-fuchsia-300/20 via-indigo-500/20 to-slate-950", glowClass: "shadow-[0_0_30px_rgba(168,85,247,0.18)]" },
  ...
  { nome: "Wolf Gold", provider: "PP", rota: "/jogos/wolf-gold", capa: "🐺", subtitle: "Moonlight wilds", accentClass: "from-slate-300/20 via-blue-500/15 to-slate-950", glowClass: "shadow-[0_0_30px_rgba(148,163,184,0.18)]" },
  { nome: "Book of Fallen", provider: "PP", rota: "/jogos/book-of-fallen", capa: "📖", subtitle: "Dark temple bonus", accentClass: "from-rose-300/20 via-orange-500/20 to-slate-950", glowClass: "shadow-[0_0_30px_rgba(251,113,133,0.18)]" },
  { nome: "Joker's Jewels", provider: "PP", rota: "/jogos/jokers-jewels", capa: "🃏", subtitle: "Classic 5-reel", accentClass: "from-violet-300/20 via-fuchsia-500/20 to-slate-950", glowClass: "shadow-[0_0_30px_rgba(192,132,252,0.18)]" },
  // BetClean Originais
