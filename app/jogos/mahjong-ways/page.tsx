    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-neutral-950 via-neutral-900 to-neutral-950 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-white">Carregando Mahjong Ways...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="mx-auto max-w-7xl px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-white">Mahjong Ways</h1>
      ...
      <div className="mx-auto max-w-7xl px-6 py-8">
        <div className="bg-black/40 rounded-2xl p-6 backdrop-blur">
          <div className="mb-6 text-center">
            <h2 className="text-2xl font-bold text-white mb-2">🎋 Mahjong Ways</h2>
            <p className="text-white/70 mb-4">Mahjong temático com 243 linhas de pagamento!</p>
            <div className="flex justify-center gap-4 text-sm">
              ...
              <span className="bg-purple-500/20 text-purple-300 px-3 py-1 rounded-full">Linhas: 243</span>
            </div>
          </div>

          <div className="aspect-video bg-black rounded-xl overflow-hidden mb-6">
            <iframe
              src="https://demogamesfree.pragmaticplay.net/gs2c/openGame.do?lang=en&cur=EUR&gameSymbol=vs10mahjong&websiteUrl=https%3A%2F%2Fdemogamesfree.pragmaticplay.net&jurisdiction=99"
              className="w-full h-full border-0"
              title="Mahjong Ways Demo"
              allowFullScreen
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white/5 rounded-xl p-4 text-center">
              ...
              <p className="text-sm text-white/70">Combine símbolos Mahjong em 243 linhas diferentes</p>
            </div>
            <div className="bg-white/5 rounded-xl p-4 text-center">
              <h3 className="font-semibold text-white mb-2">🎁 Recursos</h3>
              <p className="text-sm text-white/70">Multiplicadores, wilds e rodadas grátis</p>
            </div>
            <div className="bg-white/5 rounded-xl p-4 text-center">
