      ...
      <div className="mx-auto max-w-7xl px-6 py-8">
        <div className="bg-black/40 rounded-2xl p-6 backdrop-blur">
          <div className="mb-6 text-center">
            <h2 className="text-2xl font-bold text-white mb-2">⚡ Gates of Olympus</h2>
            <p className="text-white/70 mb-4">Mitologia grega com Zeus e multiplicadores elétricos!</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white/5 rounded-xl p-4 text-center">
              ...
              <p className="text-sm text-white/70">Ative Zeus para multiplicadores elétricos</p>
            </div>
            <div className="bg-white/5 rounded-xl p-4 text-center">
              <h3 className="font-semibold text-white mb-2">🎁 Recursos</h3>
              <p className="text-sm text-white/70">Multiplicadores até 500x + Anti-bonus</p>
            </div>
            <div className="bg-white/5 rounded-xl p-4 text-center">
