...
const gameUrl =
  "https://demogamesfree.pragmaticplay.net/gs2c/openGame.do?lang=pt&cur=BRL&gameSymbol=vs40wildwest&websiteUrl=https%3A%2F%2Fdemogamesfree.pragmaticplay.net&jurisdiction=99";
      ...
      <div className="h-16 border-b border-white/10 bg-black/70 backdrop-blur">
        <div className="mx-auto flex h-full max-w-7xl items-center justify-between px-4">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-sm font-semibold sm:text-base">🏜️ Wild West Gold</h1>
          </div>
          <div className="flex items-center gap-4">
        ...
        {carregando && (
          <div className="absolute inset-0 z-10 flex items-center justify-center bg-black/80">
            <div className="text-center">
              ...
              <p className="text-sm text-white/80">Carregando Wild West Gold...</p>
            </div>
          </div>
        )}
        <iframe
